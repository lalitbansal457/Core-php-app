...
<div class="row" style="border:1px solid black;background-color:red;border-radius:25px;box-shadow:10px 10px 5px;">
            ...
            <a href="bookdata.php" class="btn btn-success btn-sm">add new</a></div>
                                <div class="text-muted bootstrap-admin-box-title"><kbd>Book data</kbd></div>
                            </div>
<div class="bootstrap-admin-panel-content" style="background-color:black;">
                                <table class="table">
                                    <thead style="background-color:red;border:1px solid black;border-radius:25px;">
                                        <tr>
...
?>
		...
		<td><a href="delete.php?did=<?php echo $fty['id']; ?>"><input type="button" class="btn btn-danger btn-sm" value="delete"> </a> </td>
	<td> <a href="update.php?uid=<?php echo $fty['id']; ?>"><input type="button" class="btn btn-success btn-sm" value="update"> </a> </td>
                                        </tr>

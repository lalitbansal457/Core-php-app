        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <form class="form-horizontal" method="post" action="add_market.php" enctype="multipart/form-data">
                        <fieldset>
                            <legend>Marketing</legend>
                            <div class="form-group">
                                <label class="col-lg-2 control-label" for="typeahead">Market title </label>
                                <div class="col-lg-10">
                                    <input type="text" class="col-md-6" name="market_title">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-2 control-label" for="typeahead">Market description </label>
                                <div class="col-lg-10">
                                    <textarea name="market_description" id="" cols="55" rows="10"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-2 control-label" for="typeahead">Market image </label>
                                <div class="col-lg-10">
                                    <input type="file" class="col-md-6" name="market_image">
                                </div>
                            </div>
                        </fieldset>

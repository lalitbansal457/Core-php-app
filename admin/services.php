        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <form class="form-horizontal" method="post" action="add_service.php" enctype="multipart/form-data">
                        <fieldset>
                            <legend>Services</legend>
                            <div class="form-group">
                                <label class="col-lg-2 control-label" for="typeahead" >Service title </label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control col-md-6" name="service_title">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-2 control-label" for="typeahead" >Service description </label>
                                <div class="col-lg-10">
                                    <textarea name="service_description" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-2 control-label" for="typeahead" >Service icon </label>
                                <div class="col-lg-10">

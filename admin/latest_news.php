        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <form class="form-horizontal" method="post" action="add_news.php" enctype="multipart/form-data">
                        <fieldset>
                            <legend>Latest news</legend>
                            <div class="form-group">
                                <label class="col-lg-2 control-label" for="typeahead">News date </label>
                                <div class="col-lg-10">
                                    <input type="text" class="col-md-6" name="news_date">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-2 control-label" for="typeahead">News description </label>
                                <div class="col-lg-10">
                                    <textarea name="news_description" id="" cols="55" rows="10"></textarea>
                                </div>
                            </div>
                        </fieldset>
